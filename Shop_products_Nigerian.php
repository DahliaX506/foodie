...
$cxn = mysqli_connect($host,$user,$passwd,$database);
$sql_price = "SELECT price FROM nigerian_meal WHERE catalog_number='$catalog_number'";
...
$cxn = mysqli_connect($host,$user,$passwd,$database);
$query_nigerian = "SELECT * FROM nigerian_meal WHERE category = 'NIGERIAN' AND type='$_POST[interest]'  ORDER BY name";
$result = mysqli_query($cxn,$query_nigerian)
or die ("query_nigerian: ".mysqli_error($cxn));
$n=1;
...
{
$cxn = mysqli_connect($host,$user,$passwd,$database);
$sql_cat = "SELECT DISTINCT category,type,picture FROM nigerian_meal ORDER BY category,type";
