...
<head>
	...
	<title>foodie.net - Place Bulk/ Special Order</title>
...
<header id="header">
	...
	<h1 style="background-color: #fff; opacity: 0.7;">&nbsp;&nbsp;&nbsp;&nbsp;foodie.net - Bulk/Special Order Placement</h1>
	</div>
	...
	<div class="container">
			<div class="col-sm-8 col-sm-offset-2" align="center">
						...
						?>
							...
							<div class="form-group">
								<label for="inputDate">Please Enter Date of Delivery (Format:Year-month-day e.g 2016-06-20)</label>
								<input type="text" name="deliver_day" class="form-control" id="inputDate" placeholder="Enter date of delivery...">
							</div>

							<div class="form-group">
								<label for="inputTime">Please Enter Time of Delivery (e.g 8.45am)</label>
								<input type="text" name="deliver_time" class="form-control" id="inputTime" placeholder="Enter time of delivery...">
							</div>
						<div class="form-group">
								<label for="inputLocation">Enter Delivery Location</label>
								<input type="text" name="deliver_location" class="form-control" id="inputLocation" placeholder="Enter your delivery location...">
							</div>

							<div class="form-group">
								<label for="inputComment">Enter Order Specifications</label>
...
Please note that this form applies to both special and bulk order placement. You are adviced to be brief, clear and specific in your order placement</div>
	</div>	<!-- /container -->
