...
$cxn = mysqli_connect($host,$user,$passwd,$database);
$sql_price = "SELECT price FROM snacks_bakery WHERE catalog_number='$catalog_number'";
...
$cxn = mysqli_connect($host,$user,$passwd,$database);
$query_snacks = "SELECT * FROM snacks_bakery WHERE category = 'SNACKS & BAKERY' AND type='$_POST[interest]'  ORDER BY name";
$result = mysqli_query($cxn,$query_snacks)
or die ("query_snacks: ".mysqli_error($cxn));
$n=1;
...
{
$cxn = mysqli_connect($host,$user,$passwd,$database);
$sql_cat = "SELECT DISTINCT category,type,picture FROM snacks_bakery ORDER BY category,type";
