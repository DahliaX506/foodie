...
$cxn = mysqli_connect($host,$user,$passwd,$database);
$sql_price = "SELECT price FROM continental WHERE catalog_number='$catalog_number'";
...
$cxn = mysqli_connect($host,$user,$passwd,$database);
$query_continental = "SELECT * FROM continental WHERE type='$_POST[interest]'  ORDER BY name";
$result = mysqli_query($cxn,$query_continental)
or die ("query_continental: ".mysqli_error($cxn));
$n=1;
...
{
$cxn = mysqli_connect($host,$user,$passwd,$database);
$sql_cat = "SELECT DISTINCT category,type,picture FROM continental ORDER BY category,type";
