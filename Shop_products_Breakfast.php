...
$cxn = mysqli_connect($host,$user,$passwd,$database);
$sql_price = "SELECT price FROM breakfast WHERE catalog_number='$catalog_number'";
...
$cxn = mysqli_connect($host,$user,$passwd,$database);
$query_breakfast = "SELECT * FROM breakfast WHERE category = 'BREAKFAST' AND type='$_POST[interest]'  ORDER BY name";
$result = mysqli_query($cxn,$query_breakfast)
or die ("query_breakfast: ".mysqli_error($cxn));
$n=1;
...
{
$cxn = mysqli_connect($host,$user,$passwd,$database);
$sql_cat = "SELECT DISTINCT category,type,picture FROM breakfast ORDER BY category,type";
