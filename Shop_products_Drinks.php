...
$cxn = mysqli_connect($host,$user,$passwd,$database);
$sql_price = "SELECT price FROM drinks WHERE catalog_number='$catalog_number'";
...
$cxn = mysqli_connect($host,$user,$passwd,$database);
$query_drinks = "SELECT * FROM drinks WHERE category = 'DRINK' AND type='$_POST[interest]'  ORDER BY name";
$result = mysqli_query($cxn,$query_drinks)
or die ("query_drinks: ".mysqli_error($cxn));
$n=1;
...
{
$cxn = mysqli_connect($host,$user,$passwd,$database);
$sql_cat = "SELECT DISTINCT category,type,picture FROM drinks ORDER BY category,type";
