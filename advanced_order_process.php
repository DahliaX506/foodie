...
$sql = "INSERT INTO advanced_order (create_date, customer_name, customer_email, customer_phone, restaurant, item, pickup, location, comments) VALUES ('$create_date', '$_POST[customer_name]', '$_POST[customer_email]', '$_POST[customer_phone]', '$_POST[restaurant]', '$_POST[item]', '$_POST[pickup]', '$_POST[location]', '$_POST[comments]')";
if(!mysqli_query($cxn,$sql))
{
	die("Error: ".mysqli_error($cxn));
}
header("Location: advanced_order.php");
