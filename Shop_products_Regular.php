...
$cxn = mysqli_connect($host,$user,$passwd,$database);
$sql_price = "SELECT price FROM regular_meal WHERE catalog_number='$catalog_number'";
...
$cxn = mysqli_connect($host,$user,$passwd,$database);
$query_regular = "SELECT * FROM regular_meal WHERE category = 'REGULAR MEAL' AND type='$_POST[interest]'  ORDER BY name";
$result = mysqli_query($cxn,$query_regular)
or die ("query_regular: ".mysqli_error($cxn));
$n=1;
...
{
$cxn = mysqli_connect($host,$user,$passwd,$database);
$sql_cat = "SELECT DISTINCT category,type,picture FROM regular_meal ORDER BY category,type";
