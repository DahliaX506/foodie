...
$cxn = mysqli_connect($host,$user,$passwd,$database);
$sql_price = "SELECT price FROM fast_food WHERE catalog_number='$catalog_number'";
...
$cxn = mysqli_connect($host,$user,$passwd,$database);
$query_fastfood = "SELECT * FROM fast_food WHERE category = 'FAST FOOD' AND type='$_POST[interest]'  ORDER BY name";
$result = mysqli_query($cxn,$query_fastfood)
or die ("query_fastfood: ".mysqli_error($cxn));
$n=1;
...
{
$cxn = mysqli_connect($host,$user,$passwd,$database);
$sql_cat = "SELECT DISTINCT category,type,picture FROM fast_food ORDER BY category,type";
