...
$cxn = mysqli_connect($host,$user,$passwd,$database);
$sql_price = "SELECT price FROM chinese WHERE catalog_number='$catalog_number'";
...
$cxn = mysqli_connect($host,$user,$passwd,$database);
$query_chinese = "SELECT * FROM chinese WHERE type='$_POST[interest]'  ORDER BY name";
$result = mysqli_query($cxn,$query_chinese)
or die ("query_chinese: ".mysqli_error($cxn));
$n=1;
...
{
$cxn = mysqli_connect($host,$user,$passwd,$database);
$sql_cat = "SELECT DISTINCT category,type,picture FROM chinese ORDER BY category,type";
